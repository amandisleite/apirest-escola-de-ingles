...
class MatriculaController {
    ...
    static async atualizaMatricula(req, res) {
        ...
        try {
            ...
            res.status(200).json({ mensagem: `matrícula id ${matriculaId} atualizada` });
        } catch (error) {
            return res.status(500).json(error.message);
        }
    }
    ...
    static async apagaMatricula(req, res) {
        ...
        try {
            ...
            return res.status(200).json({ mensagem: `matrícula ${matriculaId} deletada` })
        } catch (error) {
            return res.status(500).json(error.message);
        }
    }
    ...
    static async pegaMatriculasPorTurma(req, res) {
        ...
        try {
            const todasMatriculas = await matriculasServices
